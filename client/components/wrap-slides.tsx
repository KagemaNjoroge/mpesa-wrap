...
export function IntroSlide({ data }: SlideProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center space-y-2 sm:space-y-4 p-4 sm:p-6 pt-10 sm:pt-12">
      <div className="w-14 h-14 sm:w-20 sm:h-20 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center mb-1 sm:mb-2 animate-[bounce_1s_ease-in-out_3]">
        <Image
          src="/mpesa.png"
          alt="M-PESA Logo"
          width={80}
          height={80}
          className="w-12 h-12 sm:w-16 sm:h-12"
        />
      </div>
      ...
      <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold text-gray-900 dark:text-white animate-fade-in animation-delay-200">
        Your M-PESA
      </h1>
      <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold text-green-600 animate-fade-in animation-delay-400">
        Wrapped
      </h2>
      
      <p className="text-xs sm:text-base text-gray-500 dark:text-gray-400 max-w-md animate-fade-in animation-delay-600">
        Let's take a look at how your money moved
      </p>
      
      <div className="pt-1 sm:pt-2 space-y-1 animate-fade-in animation-delay-800">
...
export function SummarySlide({ data }: SlideProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center space-y-3 sm:space-y-6 p-4 sm:p-6 pt-10 sm:pt-12">
      <h2 className="text-xl sm:text-3xl font-bold text-gray-900 dark:text-white animate-fade-in">
        Your Money Movement
      </h2>
      
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 w-full max-w-2xl">
        <div className="bg-green-50 dark:bg-green-950/30 rounded-xl sm:rounded-2xl p-3 sm:p-6 space-y-1 animate-slide-up">
        ...
        <div className="bg-red-50 dark:bg-red-950/30 rounded-xl sm:rounded-2xl p-3 sm:p-6 space-y-1 animate-slide-up animation-delay-200">
...
export function TopCategoriesSlide({ data }: SlideProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center space-y-3 sm:space-y-5 p-4 sm:p-6 pt-10 sm:pt-12">
      <h2 className="text-xl sm:text-3xl font-bold text-gray-900 dark:text-white animate-fade-in">
        Top Spending Categories
      </h2>
...
export function SoulmatesSlide({ data }: SlideProps) {
  ...
  if (!topSender && !topReceiver) {
    return (
      <div className="flex flex-col items-center justify-center h-full text-center space-y-3 sm:space-y-6 p-4 sm:p-6 pt-10 sm:pt-12">
        <Users className="w-10 h-10 sm:w-14 sm:h-14 text-green-600 animate-bounce" />
        <h2 className="text-2xl sm:text-4xl font-bold text-gray-900 dark:text-white animate-fade-in">
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center space-y-3 sm:space-y-5 p-4 sm:p-6 pt-10 sm:pt-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-6 w-full max-w-3xl">
        {topSender && (
          <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950/30 dark:to-green-900/20 rounded-xl sm:rounded-2xl p-3 sm:p-6 space-y-1 sm:space-y-2 animate-slide-up">
            <p className="text-xs sm:text-sm font-semibold text-green-700 dark:text-green-400 uppercase tracking-wide">
              Top Sender
            </p>
            <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-full bg-green-600 mx-auto flex items-center justify-center">
        ...
        {topReceiver && (
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950/30 dark:to-blue-900/20 rounded-xl sm:rounded-2xl p-3 sm:p-6 space-y-1 sm:space-y-2 animate-slide-up animation-delay-200">
            <p className="text-xs sm:text-sm font-semibold text-blue-700 dark:text-blue-400 uppercase tracking-wide">
              Top Receiver
            </p>
            <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-full bg-blue-600 mx-auto flex items-center justify-center">
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center space-y-3 sm:space-y-5 p-4 sm:p-6 pt-10 sm:pt-12">
      <div className="relative">
        <Banknote className="w-10 h-10 sm:w-16 sm:h-16 text-green-600 animate-pulse" />
      ...
      <div className="mt-2 sm:mt-4 p-3 sm:p-4 bg-yellow-50 dark:bg-yellow-950/30 rounded-xl sm:rounded-2xl max-w-md animate-fade-in animation-delay-800">
...
export function TimeOfDaySlide({ data }: SlideProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center space-y-2 sm:space-y-4 p-4 sm:p-6 pt-10 sm:pt-12">
      <Clock className="w-8 h-8 sm:w-12 sm:h-12 text-green-600 animate-spin-slow" />
      <h2 className="text-xl sm:text-3xl font-bold text-gray-900 dark:text-white animate-fade-in">
        When You Spend
      </h2>
      ...
      <div className="space-y-2 sm:space-y-4">
        <div className="animate-bounce">
          <topTime.icon className="w-8 h-8 sm:w-12 sm:h-12 text-green-600 mx-auto" />
        </div>
        ...
        <p className="text-xl sm:text-3xl font-bold text-green-600 animate-fade-in animation-delay-200">
      ...
      <div className="grid grid-cols-4 gap-2 sm:gap-3 w-full max-w-2xl mt-2 sm:mt-4">
        {times.map((time, idx) => {
...
export function WeekdaySlide({ data }: SlideProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center space-y-2 sm:space-y-4 p-4 sm:p-6 pt-10 sm:pt-12">
      <Calendar className="w-8 h-8 sm:w-12 sm:h-12 text-green-600 animate-pulse" />
      <h2 className="text-xl sm:text-3xl font-bold text-gray-900 dark:text-white animate-fade-in">
        Your Spending Week
      </h2>
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center space-y-3 sm:space-y-6 p-4 sm:p-6 pt-10 sm:pt-12">
      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-4 w-full max-w-2xl">
        <div className="bg-blue-50 dark:bg-blue-950/30 rounded-xl sm:rounded-2xl p-3 sm:p-6 space-y-1 sm:space-y-2 animate-slide-up">
        ...
        <div className="bg-purple-50 dark:bg-purple-950/30 rounded-xl sm:rounded-2xl p-3 sm:p-6 space-y-1 sm:space-y-2 animate-slide-up animation-delay-200">
...
export function FinalSlide({ data }: SlideProps) {
  return (
    <div className="flex flex-col items-center justify-center h-full text-center space-y-3 sm:space-y-5 p-4 sm:p-6 pt-10 sm:pt-12">
      <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-green-600 flex items-center justify-center animate-bounce">
        <Check className="w-6 h-6 sm:w-8 sm:h-8 text-white" strokeWidth={3} />
      </div>
      
      <h2 className="text-xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-white animate-fade-in">
        That's Your
      </h2>
      <h2 className="text-xl sm:text-3xl md:text-4xl font-bold text-green-600 animate-fade-in animation-delay-200">
        M-PESA Wrapped!
      </h2>
      ...
      <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 mt-2 sm:mt-4 animate-fade-in animation-delay-600 w-full max-w-md sm:max-w-none sm:w-auto">
        <button 
